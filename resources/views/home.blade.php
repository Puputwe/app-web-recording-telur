...
<head>
  ...
  <title>Recording Telur Ayam | KWT Kembang Wono</title>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle text-white">{{ Auth::user()->name }}</a>
